  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ margin: 0, fontSize: '1.75rem', fontWeight: 600, color: 'var(--foreground)' }}>
          This page wandered off
        </h1>
        <p style={{ margin: 0, maxWidth: '34rem', fontSize: '1rem', color: 'var(--muted)' }}>
          We couldn&rsquo;t find the page you were looking for. It may have been moved, deleted, or
          never existed.
        </p>
      </div>
